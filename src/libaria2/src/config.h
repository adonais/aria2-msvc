...
#if defined(_GNUC__) || (defined(__clang__) && !defined(_MSC_VER))
#define ALLOW_UNUSED_TYPE __attribute__((unused))
#else
#define ALLOW_UNUSED_TYPE
#endif

#define BUILD "x86_64-MSVC"
...
#if !defined(HAVE_ASCTIME_R) && defined(_MSC_VER)
...
#define localtime_r(now, tm) (localtime_s(tm, now) ? NULL : tm)
...
/* #undef HAVE_TIMEGM */
#if !defined(HAVE_TIMEGM) && defined(_MSC_VER)
...
#define PACKAGE_STRING "aria2" VERSION
